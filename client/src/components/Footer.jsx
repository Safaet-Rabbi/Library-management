        ...
        <div>
            <footer className="text-white bg-[#141E46] px-4 py-5 md:px-8">
                <div className="max-w-lg sm:mx-auto text-center">
                    <Link to="/" className="text-3xl lg:text-4xl font-semibold flex justify-center">Book <span className="text-[#41B06E]">Sphere</span></Link>
                ...
                <div className="mt-4 lg:mt-8 items-center lg:flex-row flex-col-reverse justify-between flex gap-4">
                    <div className="mt-4 sm:mt-0">
                        &copy; 2024 <span>Book <span className="text-[#41B06E]">Sphere</span></span> || All rights reserved.
                    </div>
